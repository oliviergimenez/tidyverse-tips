...
For illustration, we will use the `starwars` dataset that comes with `tidyverse`
...
To get a sense of the data, count stuff and use `sort = TRUE` to arrange thing by decreasing counts
